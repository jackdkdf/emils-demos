...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        description="CS:GO Match Prediction ML Project",
...
Examples:
  ...
  python -m src.main visualize --data data/preprocessed/final_features.csv
    ...
    train_parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Path to final_features.csv"
    )
    train_parser.add_argument(
        "--no-balance",
        action="store_true",
    ...
    # Visualize command
    visualize_parser = subparsers.add_parser("visualize", help="Create visualizations for model evaluation")
    ...
    if args.command == "preprocess":
        ...
        match_features_file = project_root / "data" / "preprocessed" / "match_features.csv"
        final_features_file = project_root / "data" / "preprocessed" / "final_features.csv"
        ...
        print("CS:GO Match Prediction ML Project")
        print("A machine learning project for predicting CS:GO match outcomes")
